...
def get_prompt(module_type, data_text):
    ...
    if module_type == "finance":
        ...
        3. 【细节保留】：summary 必须包含具体数字（如涨跌幅%、金额、日期），拒绝模糊描述。总结的内容如果有数字请用①②③...代替，事件开头分点使用1，2，3...来分点
        ...
        【🚀 颠覆性突破】（这里至少要有8点核心事件，请你认真阅读总结出来）总结的内容如果有数字请用①②③...代替，事件开头分点使用1，2，3...来分点
        1. ...
        ...
        分点输出：
        （这里至少要有8点事件，请你认真阅读总结出来）总结的内容如果有数字请用①②③...代替，事件开头分点使用1，2，3...来分点
        【🌍 地缘焦点】
        1. ...
